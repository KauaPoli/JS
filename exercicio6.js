...
//     };
//   }
//   const carro = descreverMeuCarro(); 
  //chama a função e armazena
  //console.log(carro); 
  //exibe o objeto no console


  //2-pegar marca do carro
...
//     return carro.ano;
//   }
//   console.log(getAnoCarro(carro)); 
//   // (chama e mostra o resultado
 

  //4-atualizar modelo do carro
...
//   };
 ...
 // function atualizarModeloCarro(carro, novoModelo) {
    ...
    // (Atualiza a propriedade 'modelo' do objeto carro
    //return carro;  
...
//   }
 ...
 // const produto = criarProduto("Notebook", 2500.00, "ABC123");
  ...
  //6-mostrar preço do produto
  // Definindo um objeto produto
// const produto = {
//     nome: "Smartphone galaxy A32",
//     preco: 1600.00,
//     codigo: "XYZ780"
//   };
...
//   }
  // (Chama a função para exibir o preço do produto
  //mostrarPrecoProduto(produto);
 

  //7-adicionar estoque ao produto
// Definindo um objeto produto
// const produto = {
...
//   };
 ...
 // }
  // (Chama a função para adicionar o estoque ao produto
  //const produtoComEstoque = adicionarEstoqueProduto(produto, 50);
  // (Mostra o objeto produto com a nova propriedade estoque
